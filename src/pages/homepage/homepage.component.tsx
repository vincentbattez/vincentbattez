  ...
  return (
    <section className="page-homepage container">
      <Helmet>
        ...
        <meta itemProp="name" content="🏆 Développeur Vue.js Freelance - Vincent Battez"/>
        <meta itemProp="description" content="✅ Développeur Front-End confirmé - Portfolio de Vincent Battez"/>
        <meta itemProp="image" content="https://s3.eu-west-3.amazonaws.com/vincentbattez.dev/opengraph-vincentbattez-dev.jpg"/>
        <meta name="twitter:card" content="summary"/>
        <meta name="twitter:title" content="🏆 Développeur Vue.js Freelance - Vincent Battez"/>
        <meta name="twitter:description" content="✅ Développeur Front-End confirmé - Portfolio de Vincent Battez"/>
        ...
        <meta name="og:title" content="🏆 Développeur Vue.js Freelance - Vincent Battez"/>
        <meta name="og:description" content="✅ Développeur Front-End confirmé - Portfolio de Vincent Battez"/>
        ...
        <meta name="og:site_name" content="Développeur Vue.js Freelance - Vincent Battez"/>
